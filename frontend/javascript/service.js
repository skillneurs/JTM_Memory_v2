...
const exempleCarousel1 = new Carouse1(
  galleryContainer,
  galleryItems,
  galleryControls
);
...
const link4 = document.querySelector(".gallery_item_5");
...
const link2 = document.querySelector(".gallery_item_4");
link2.addEventListener("click", function () {
  window.location = "customlevel.html";
});